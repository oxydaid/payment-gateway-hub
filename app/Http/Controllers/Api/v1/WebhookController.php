...
class WebhookController extends Controller
{
    ...
    #[HeaderParameter('X-Callback-Event', 'The callback event name. Must be \'payment_status\'.', type: 'string', required: true)]
    #[HeaderParameter('X-Callback-Signature', 'The HMAC-SHA256 signature generated by TriPay.', type: 'string', required: true)]
    public function tripay(Request $request): JsonResponse
    {
        ...
        $signature = $request->header('X-Callback-Signature') ?: $request->header('x-callback-signature');
        if (empty($signature)) {
            Log::warning('Tripay webhook rejected: missing signature header.', [
                'headers' => $request->headers->all(),
            ]);
