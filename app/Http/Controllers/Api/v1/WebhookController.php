...
class WebhookController extends Controller
{
     ...
     */
    #[HeaderParameter('X-Callback-Event', description: 'The event type.', type: 'string', required: true, default: 'payment_status')]
    #[HeaderParameter('X-Callback-Signature', description: 'The HMAC-SHA256 signature generated by TriPay.', type: 'string', required: true)]
